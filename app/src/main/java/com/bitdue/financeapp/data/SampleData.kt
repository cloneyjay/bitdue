...
object SampleData {
    ...
    val categories = listOf(
        Category("1", "Food & Dining", "🍔", CategoryFood.value.toLong(), TransactionType.EXPENSE),
        ...
        Category("8", "Salary", "💰", CategorySalary.value.toLong(), TransactionType.INCOME),
        Category("9", "Freelance", "💼", CategoryFreelance.value.toLong(), TransactionType.INCOME),
